# Quick Installation Guide - v2.4.1

## 🚀 Fast Installation (Recommended)

### Using Hammerhead App (Easiest)

1. **Download** `Enhance-d_Club_Glucose_Karoo_v2.4.1.apk` from this release
...
1. **Download** `Enhance-d_Club_Glucose_Karoo_v2.4.1.apk`
2. **Enable USB debugging** on your Karoo:
   - Settings → About → Tap "Build Number" 7 times
   - Settings → Developer Options → Enable "USB Debugging"
3. **Connect** via USB to your computer
4. **Install**: `adb install Enhance-d_Club_Glucose_Karoo_v2.4.1.apk`
...
- **Version Update**: Minor version bump with build improvements
