# Enhance-d Club Glucose - Karoo v2.5.0

## 🎉 Release Highlights

**Improved Update Detection**

This release fixes the automatic update detection system to correctly handle GitHub release tags with suffixes, ensuring users are always notified of available updates.
...
- **Improved Update Detection**: Fixed version comparison to correctly handle GitHub release tags with suffixes
  ...
  - Enhanced version parsing logic strips suffixes before comparing versions
  - Ensures users always get notified of available updates, regardless of release tag format

### 🔧 Improvements

- **Better Version Parsing**: Enhanced version comparison logic
  - Handles tags like `v2.4.1-beta`, `v2.5.0-alpha`, `v2.3.0-rc1`, etc.
  - More robust update detection across different release naming conventions
  - Prevents false "up to date" messages when newer versions are available
...
- xDrip+ running locally on the Karoo device (e.g. xDrip+ installed on Karoo device)
...
4. Install using: `adb install Enhance-d_Club_Glucose_Karoo_v2.5.0.apk`
...
- **Improved Compatibility**: Now correctly detects updates from pre-release and beta tags
...
**File**: `Enhance-d_Club_Glucose_Karoo_v2.5.0.apk`  
