# Enhance-d Club Glucose - Karoo v2.5.0 Release

## 📦 Release Files

- **`Enhance-d_Club_Glucose_Karoo_v2.5.0.apk`** - Signed APK with improved update detection
- **`RELEASE_NOTES_v2.5.0.md`** - Comprehensive release notes
- **`INSTALLATION_GUIDE_v2.5.0.md`** - Quick installation guide
- **`SHA256_CHECKSUM_v2.5.0.txt`** - SHA256 checksum for file verification

## 🎯 What's New in v2.5.0

### ✨ New Features

- **Improved Update Detection**: Fixed version comparison to correctly handle GitHub release tags with suffixes (e.g., `v2.4.1-beta`)
  - Now properly detects updates even when releases are marked as pre-releases or have version suffixes
  - Ensures users always get notified of available updates

### 🔧 Improvements

- **Better Version Parsing**: Enhanced version comparison logic to strip suffixes before comparing
  - Handles tags like `v2.4.1-beta`, `v2.5.0-alpha`, etc.
